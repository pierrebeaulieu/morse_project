...
audio_to_vect audio_to_chaine(char* path_wav, float pas) 
{
    FILE*        pfile;
    char*        mystring;
...
void audio_to_vect::letter_separator(void)
{
    ...
    // On a les valeur de 0 et 1 correspondant à un tiret.
    // On va remettre en forme le signal selon nos convention: "000" pour un blanc et "111" pour un tiret.
    ...
    // Ici on sépare chaque lettre et on intercalle un blanc entre les mots.
